...
3. [EDA](#3-edaA)
4. [모델 개요](#4-모델-개요)
<br> a. [사용 모델 선택](#a-사용-모델-선택)
<br> b. [하이퍼 파라미터](#b-하이퍼-파라미터)
<br> c. [Persona](#c-parameter-efficient-fine-tuning-peft)

5. [사용 프롬프트](#5-사용-프롬프트)
<br> a. [Textgrad](#a-textgrad)
<br> b. [CoT](#b-cot)
<br> c. [Persona](#c-persona)
<br> d. [Categorized](#d-categorized)
<br> e. [Korean & English](#e-korean--english)

6. [ORPO](#6-orpo)
7. [Ensemble](#7-ensemble) 
8. [레포지토리 구조](#8레포지토리-구조-repository-structure)
